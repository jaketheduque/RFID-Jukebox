...
#define RST_PIN 28 // Configurable, see typical pin layout above
#define SS_PIN 29  // Configurable, see typical pin layout above

const int playPauseButton = 3;
const int shuffleButton = 4;
...
SoftwareSerial mySoftwareSerial(5, 6); // TX, RX **Possible error in code, RX and TX pins are swapped**
...
void setup()
{
  ...
  volumeLevel = map(analogRead(volumePot), 0, 686, 0, 30); // scale the pot value and volume level
